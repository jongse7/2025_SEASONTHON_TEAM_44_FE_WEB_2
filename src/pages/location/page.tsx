...
export const LocationPage = () => {
  ...
  useSuspenseQuery(getUserLocationOptions());
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-end">
      ...
      <div className="px-5 w-full gap-[5px] flex flex-col">
        <Button
          className="w-full text-button1 text-white py-[17px] bg-primary-500  rounded-[12px] disabled:bg-gray-200 disabled:text-gray-400"
        ...
        <Button
          className="w-full text-button1 py-[17px] bg-primary-50 text-gray-800 rounded-[12px] disabled:bg-primary-300"
